...
//        let viewModel = ProfileInfoViewModel(profileModel: nil, authModel: user)
//        let nextVC = ProfileInfoView(viewModel: viewModel)
////        SwiftUI экрана
...
//        do {
//            return try await service.sendTGToken(model: authQueryModel)
//        } catch {
